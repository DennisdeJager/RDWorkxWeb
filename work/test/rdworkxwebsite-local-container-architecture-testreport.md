...
- `DATABASE_URL=postgres://rdworkxwebsite:placeholder@192.168.10.50:55436/rdworkxwebsite docker compose config` - GO
...
- API-service normaliseert `LEGACY_DATABASE_URL` met host `rdworkxwebsite-db` naar data-host `192.168.10.50:55436`.
...
- PostgreSQL-client `postgres.js` wordt alleen in de API-server geÃ¯mporteerd.
